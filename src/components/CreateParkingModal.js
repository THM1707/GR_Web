...
import {Modal, Form, Input, Tooltip, Icon, InputNumber, TimePicker, Upload, Button} from 'antd';

const ParkingCreateForm = Form.create({name: 'create_form'})(
...
export default ParkingCreateForm;
